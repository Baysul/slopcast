...
// content. These are the "sweet spots" the SVT-AV1 tuning targets: the
// encoder's VBR target is 75% of the ceiling, so 1080p60 lands at a 6 Mbps
// target on an 8 Mbps ceiling, and 1440p60 at 9 Mbps on 12 Mbps.
